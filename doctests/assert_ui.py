...
check("and it names the modules that do hold the role, read from the keystore",
      "root.identity.custodians" in block(view, 'objectName: "notCustodianNotice"', 12), True)
